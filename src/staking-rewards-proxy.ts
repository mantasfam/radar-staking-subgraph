...
export function handleClaimInitiated(event: ClaimInitiated): void {
  ...
  //
  // - contract.actionInQueue(...)
  // - contract.balances(...)
  // - contract.bytes32ToString(...)
  // - contract.controller(...)
  // - contract.controllerChainId(...)
  // - contract.estimateFees(...)
  // - contract.failedMessages(...)
  // - contract.fund(...)
  // - contract.gasAmounts(...)
  // - contract.getConfig(...)
  // - contract.getLzEndpoint(...)
  // - contract.getTrustedRemote(...)
  // - contract.isTrustedRemote(...)
  // - contract.owner(...)
  // - contract.paused(...)
  // - contract.signatures(...)
